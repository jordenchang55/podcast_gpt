...
from .client import ChatClient, WebSocketClient
...
class App:
    ...
    def __init__(self):
        ...
        self.listen_client = ListenClient(self.buffer, 30, 50)
    ...
    def start(self):
        ...
        self.web_socket_client.start(lambda msg, is_json: self._on_speak(msg, is_json))
    ...
    def _on_speak(self, text, is_json):
        self.chat_client.take_response()
